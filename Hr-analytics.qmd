...
m1$key <- paste0("HR BP Vacancy Senior")
s1$key <- paste0("HR BP Vacancy Middle")
t1$key <- paste0("Рекрутеры")
h1$key <- paste0("Специалист по обучению")
r1$key <- paste0("Специалист отдела кадров")
...
vac <- tibble("Руководитель отдела кадров" = j, "HR BP Vacancy Senior" = m, "HR BP Vacancy Middle" = s, "Рекрутеры" = t, "Специалист по обучению" = h, "Специалист отдела кадров" = r)
